...
if (a == 0) {
    ...
    if (disk > 0) {
        ...
        document.write('Your Equation: ' + a + 'x^2 + ' + b + 'x + ' + c + ' = 0');
        document.write('<br>' + '<br>' + 'Result: x1 = ' + x1 + '<br>' + 'Result: x2 = ' + x2);
    }
    else if (disk == 0) {
        const x = (-1 * b + Math.sqrt(b * b - 4 * a * c)) / 2 * a;
        document.write('Your Equation: ' + a + 'x^2 + ' + b + 'x + ' + c + ' = 0');
        document.write('<br>' + '<br>' + 'Result: x1 = ' + x);
    }
    else {
        document.write('Your Equation: ' + a + 'x^2 + ' + b + 'x + ' + c + ' = 0');
        document.write('<br>' + '<br>' + 'This equation has no real solution !');
    }
}
